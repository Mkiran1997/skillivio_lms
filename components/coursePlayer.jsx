...
function CoursePlayer({ ...props }) {
    ...
    function handleLessonTabClick() {
        if (!canProgress) {
            notify(
                "Please read and accept the Introduction and Learner Instructions first.",
                "error",
            );
            return;
        }
        ...
        >
            ...
            >
                <div style={{ padding: "16px 18px", background: s }}>
                    <button
                        onClick={function () {
                            setView(userRole === "admin" ? "admin" : "learner");
                        }}
                        style={{
                            background: "none",
                            border: "none",
                    ...
                    >
                        NQF {activeCourse && activeCourse.nqf} ·{" "}
                        {(activeCourse && activeCourse.credits) || 10} credits
                    </div>
                ...
                <div style={{ padding: "10px 10px 0" }}>
                    {NAV_TABS.map(function (t) {
                        ...
                        var isLocked =
                            (t.id === "lessons" || t.id === "materials") && !canProgress;
                        return (
                            <button
                                key={t.id}
                                onClick={function () {
                                ...
                                style={{
                                    ...
                                    padding: "9px 12px",
                                    border: "none",
                                    background: isActive ? p + "15" : "transparent",
                                    borderRadius: 8,
                                    marginBottom: 4,
                                    cursor: "pointer",
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {(activeCourse && activeCourse.thumb) || "📘"}
                                </div>
                                <div>
                                    <h1
                                        style={{
                            ...
                            >
                                ...
                                >
                                    <li>
                                        Demonstrate applied competence in the core subject matter of
                                        this qualification
                                    </li>
                                    <li>
                                        Apply theoretical knowledge to practical workplace
                                        situations
                                    </li>
                                    <li>
                                        Complete a Portfolio of Evidence (PoE) demonstrating
                                        workplace application
                                    </li>
                                    <li>
                                        Pass the final assessment with a minimum score of{" "}
                                        {(activeCourse && activeCourse.passingScore) || 75}%
                                    </li>
                                    <li>
                                        Earn {(activeCourse && activeCourse.credits) || 10} NQF
                            ...
                            <div
                                style={{
                                    background: introAccepted ? "#f0fdf4" : "#fffbeb",
                                    borderRadius: 10,
                                    padding: "18px 20px",
                                    border:
                                        "1.5px solid " + (introAccepted ? "#86efac" : "#fde68a"),
                                }}
                            >
                                <label
                                    style={{
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        >
                                            I have read and understood the course introduction
                                        </div>
                                        <div
                                            style={{
                                                fontSize: 12,
                                        ...
                                        >
                                            By ticking this box, you confirm that you have read the
                                            course overview, understand the learning outcomes, and are
                                            aware of the assessment requirements. You must acknowledge
                                            this before accessing course content.
                                        </div>
                                    </div>
                                </label>
                            </div>
                        ...
                        >
                            ...
                            {[
                                ...
                                },
                                {
                                    ...
                                    body:
                                        "The final assessment must be completed individually without assistance. You may attempt the assessment up to 3 times. A minimum score of " +
                                        ((activeCourse && activeCourse.passingScore) || 75) +
                                        "% is required to pass. Plagiarism will result in disqualification.",
                                },
                                {
                                    icon: "🔒",
                            ...
                            <div
                                style={{
                                    background: instructionsAck ? "#f0fdf4" : "#fffbeb",
                                    borderRadius: 10,
                                    padding: "18px 20px",
                                    border:
                                        "1.5px solid " + (instructionsAck ? "#86efac" : "#fde68a"),
                                    marginTop: 8,
                                }}
                            >
                                <label
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        >
                                            I acknowledge and accept these learner instructions
                                        </div>
                                        <div
                                            style={{
                                                fontSize: 12,
                                        ...
                                        >
                                            ...
                                            understood all learner instructions, including the PoE
                                            requirements, assessment rules, and code of conduct. This
                                            acknowledgement is recorded against your learner profile.
                                        </div>
                                    </div>
                                </label>
                            </div>
                    ...
                    <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
                        ...
                        >
                            <button
                                ...
                                style={{
                                    background: "#f1f5f9",
                                    color: activeLesson === 0 ? "#cbd5e1" : "#475569",
                                    border: "none",
                                    borderRadius: 8,
                                    padding: "9px 18px",
                                    fontSize: 13,
                ...
                {cpTab === "materials" && (
                    <div style={{ flex: 1, padding: "28px 36px" }}>
                        ...
                        {!canProgress && (
                            ...
                            >
                                ⚠ Please complete the Introduction and Learner Instructions to
